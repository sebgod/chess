...
public partial class GamePanel : UserControl
{
    ...
    private void GamePanel_MouseClick(object sender, MouseEventArgs e)
    {
        ...
        if (GameUI is { } gameUI)
        {
            ...
            RefreshUI(uiResponse, clipRects);
    ...
    private void GamePanel_Load(object sender, EventArgs e)
    {
        if (!IsAncestorSiteInDesignMode)
        {
            ...
            MouseWheel += GamePanel_MouseWheel;
        }
    }
    ...
    private void GamePanel_MouseWheel(object? sender, MouseEventArgs e)
    {
        ...
        if (GameUI is { } ui)
        {
            var (uiResponse, clipRects) = ui.PlyListScroll(ui.PlyListOffset + delta, ScrollType.Rows);
            RefreshUI(uiResponse, clipRects);
        }
    }
    ...
    private void GamePanel_MouseMove(object sender, MouseEventArgs e)
    {
        if (_mouseLeftDown is { } prev && GameUI is { } ui)
        {
            ...
            var (uiResponse, clipRects) = ui.PlyListScroll(deltaY, ScrollType.Pixel);
            RefreshUI(uiResponse, clipRects);
        }
    }


    private void RefreshUI(UIResponse uiResponse, ImmutableArray<RectInt> clipRects)
    {
    ...
    private void GamePanel_MouseEnter(object sender, EventArgs e) => Focus();
}
